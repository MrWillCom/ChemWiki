/**
 * Added mhchem to rehype-katex.
 *
 * Based on:
 * https://github.com/remarkjs/remark-math/blob/main/packages/rehype-katex/index.js
 *
 * The related `package.json` is minimized, all unnecessary fields are removed.
 * Based on:
 * https://github.com/remarkjs/remark-math/blob/main/packages/rehype-katex/package.json
 */
 ...
 *
 * From:
 * https://github.com/KaTeX/KaTeX/blob/main/contrib/mhchem/mhchem.js
 */
;(() => {
  /* eslint-disable */
      ...
      switch (buf.type_) {
        case 'chemfive':
          ...
          if (b5.b || b5.p) {
            ...
            res += '{\\vphantom{X}}'
            res +=
              '^{\\smash[t]{\\vphantom{2}}\\mathllap{' + (b5.b || '') + '}}'
            res +=
              '_{\\vphantom{2}\\mathllap{\\smash[t]{' + (b5.p || '') + '}}}'
          }
          //
          // o
          //
